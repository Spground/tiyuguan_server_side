	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="bs-example bs-example-form" action="reserve/userCancelReserve.action" method="post" role="form" id="deleteForm">
					...
					<button type="button" class="btn btn-primary" id="cancel">删除</button>
				</div>
				</form>
			</div>
			<!-- /.modal-content -->
